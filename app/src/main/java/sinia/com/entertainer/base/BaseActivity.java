package sinia.com.entertainer.base;
...
import sinia.com.entertainer.utils.AppInfoUtil;
import sinia.com.entertainer.utils.SystemBarTintManager;
import sinia.com.entertainer.view.loadingview.LoadingView;
...
public class BaseActivity extends AppCompatActivity {
    ...
    public TextView getText_back() {
        return text_back;
    }

    public void setText_back(TextView text_back) {
    ...
    public View createHeadView(String title) {
        ...
        text_back = (TextView) head.findViewById(R.id.text_back);
