...
import sinia.com.entertainer.db.InviteMessgeDao;
import sinia.com.entertainer.db.UserDao;
import sinia.com.entertainer.domain.EmojiconExampleGroupData;
import sinia.com.entertainer.domain.InviteMessage;
import sinia.com.entertainer.domain.RobotUser;
import sinia.com.entertainer.parse.UserProfileManager;
import sinia.com.entertainer.receiver.CallReceiver;
        ...
        messageListener = new EMMessageListener() {
            ...
            public void onMessageReceived(List<EMMessage> messages) {
                for (EMMessage message : messages) {
                    ...
                    // 存入db
                    UserDao dao = new UserDao(MyApplication.getInstance().getApplicationContext());
