package sinia.com.entertainer.db;
...
import sinia.com.entertainer.domain.InviteMessage.InviteMesageStatus;
...
public class DemoDBManager {
    ...
    synchronized public void updateMessage(int msgId, ContentValues values) {
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        if (db.isOpen()) {
            db.update(InviteMessgeDao.TABLE_NAME, values, InviteMessgeDao.COLUMN_NAME_ID + " = ?", new
                    String[]{String.valueOf(msgId)});
        }
    }
