...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected String toChatUsername,nickName;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        nickName = fragmentArgs.getString("username");
    ...
    private void sendAtMessage(String content) {
        ...
        if (EMClient.getInstance().getCurrentUser().equals(group.getOwner()) && EaseAtMessageHelper.get()
            ...
            message.setAttribute(EaseConstant.MESSAGE_ATTR_AT_MSG,
                    EaseAtMessageHelper.get().atListToJsonArray(EaseAtMessageHelper.get().getAtMessageUsernames
                            (content)));
        }
        sendMessage(message);
