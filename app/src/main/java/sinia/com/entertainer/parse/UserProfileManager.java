package sinia.com.entertainer.parse;
...
import sinia.com.entertainer.DemoHelper.DataSyncListener;
...
public class UserProfileManager {
    ...
    public void asyncFetchContactInfosFromServer(List<String> usernames, final EMValueCallBack<List<EaseUser>>
            callback) {
    ...
    public void asyncGetCurrentUserInfo(String nick, String image) {
