package sinia.com.entertainer.view.slideview;
...
//	private DisplayImageOptions uOption;
    ...
    public SlideShowView1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlideShowView1(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        this.context = context;
        LayoutInflater.from(context).inflate(R.layout.layout_slideshow1, this,
                true);
    ...
    private void initUI() {
        ...
        for (int i = 0; i < imageUrls.size(); i++) {
            ...
            LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                    Utils.dip2px(context, 6), Utils
                    .dip2px(context, 6));
            lp.setMargins(Utils.dip2px(context, 3),
                    Utils.dip2px(context, 5),
                    Utils.dip2px(context, 3), Utils
                            .dip2px(context, 3));
...
//			view.setBackgroundResource(R.drawable.icon_app_downloading);
            view.setScaleType(ScaleType.FIT_XY);
            if (!("").equals(imageUrls.get(pos))) {
//				 ImageLoader.getInstance().displayImage(imageUrls.get(pos),
//				 view, uOption);
                //    BitmapUtilsHelp.getImage(getContext(), R.drawable.moren1).display(view, imageUrls.get(pos));
                Glide.with(context).load(imageUrls.get(pos)).crossFade()
                        .into(view);
